...
// panel_welcome 2
        ...
        button_buck = new JButton("BACK");
        button_buck.setFont(new Font("Times New Roman", Font.BOLD, 20));
        panel_info.add(button_buck);
